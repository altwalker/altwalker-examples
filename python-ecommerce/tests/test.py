...
class BaseModel(unittest.TestCase):
    ...
    def v_homepage(self):
        ...
        self.assertTrue(page.is_products_list_present, "Products list should be present.")
    ...
    def v_cart_open_and_not_empty(self):
        ...
        self.assertTrue(page.is_content_next_button_present, "Content next step button should be presents.")
        self.assertGreater(page.total_items_in_cart, 0, "Should have at least one item in cart.")
...
class CheckoutModel(BaseModel):
    ...
    def v_billing_address(self):
        ...
        self.assertTrue(page.is_billing_next_button_present, "Billing next step button should be presents.")

    def v_payment_method(self):
        page = CartPage(self.driver)
        page.wait_for_snipcart()

        self.assertTrue(page.is_payment_next_button_present, "Payment next step button should be presents.")

    def v_order_confirmation(self):
        page = CartPage(self.driver)
        page.wait_for_snipcart()

        self.assertTrue(page.is_order_confirmation_present, "Order next step button should be presents.")
